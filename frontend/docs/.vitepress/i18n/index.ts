...
export default {
  'zh-CN': {
    ...
    order: {
      ...
      bankTransfer: '银行转账',
      transactionId: '交易号',
      transactionIdPlaceholder: '请输入交易号',
      callLimit: '调用次数限制',
  ...
  'en': {
    ...
    order: {
      ...
      transactionIdPlaceholder: 'Please enter transaction ID',
      ...
      detailFailed: 'Failed to get order details',
